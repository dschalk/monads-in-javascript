	...
	function main(sources) {
	  ...
	  */
	  ...
	  var doubleAction$ = doublePress$.map(function (e) {
	    ...
	    mMZ19.bnd(function (v) {
	      return bind(bind(v)(function (s) {
	        return s * s * s;
	      })(function (w) {
	        return w + 3;
	      })(function (a) {
	        return a * a;
	      })(terminate)[3] / 100) // End of inner bind().
	      (function (x) {
	        return x * x;
	      })(terminate)[1];
	    }); // Now the outer bind() is working.
	    if (e.keyCode === 13) {
	      doubleResult = (0, _dom.h)('div', styleFunc(["#FFD700",, "16px",,,]), mMZ19.release(pInt(e.target.value)));
	    }
	  });
	  // ******************************************************************** <><><><><><> -> End Demos
